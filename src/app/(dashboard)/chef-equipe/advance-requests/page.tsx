...
export default function ChefAdvanceRequestsPage() {
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-fade-in">
                <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">Soumettez et suivez vos demandes d&apos;avance</p>
                </div>
            ...
            {loading ? (
                ...
                <div className="card text-center py-16">
                    ...
                    <p className="text-slate-400">Vous n&apos;avez pas encore fait de demande</p>
                </div>
            ) : (
                    ...
                    <div className="bg-[#0d1626] border border-white/10 rounded-[2rem] w-full max-w-lg p-6" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea value={form.reason} onChange={e => setForm({...form, reason: e.target.value})} rows={4} placeholder="Achat de matériel urgent, Transport..." className="input-field w-full resize-none" />
                            </div>
                        </div>
