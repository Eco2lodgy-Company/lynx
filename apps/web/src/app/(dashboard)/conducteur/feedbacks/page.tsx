...
import { useFeedbacks, useUpdateFeedbackStatus } from "@lynx/api-client";
...
interface Feedback extends Partial<SharedFeedback> {
    id: string;
    subject: string;
    message: string;
...
const STATUS_MAP: Record<FeedbackStatus, { label: string; color: string; icon: React.ReactNode }> = {
...
export default function ConducteurFeedbacksPage() {
    const { data: feedbacks = [], isLoading: loading } = useFeedbacks();
