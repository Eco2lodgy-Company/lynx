...
interface Incident extends Partial<SharedIncident> {
    id: string;
    title: string;
...
const SEVERITY_MAP: Record<IncidentSeverity, { label: string; color: string; icon: React.ReactNode }> = {
