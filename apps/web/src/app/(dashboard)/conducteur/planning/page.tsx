...
import { TaskStatus, Priority as TaskPriority, ProjectStatus } from "@lynx/types";
import { useTasks, useProjects } from "@lynx/api-client";

interface ProjectRef { id: string; name: string; status: ProjectStatus; progress: number; }
