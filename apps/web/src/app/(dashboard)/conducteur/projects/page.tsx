...
interface Project extends Partial<SharedProject> {
    id: string;
    name: string;
...
import { useProjects, useCreateProject, useUpdateProject, useUsers } from "@lynx/api-client";
...
export default function ConducteurProjectsPage() {
    ...
    const conducteurs = allUsers.filter((u: any) => ["ADMIN", "CONDUCTEUR"].includes(u.role));
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = editingProject ? { id: editingProject.id, data: form } : form;
