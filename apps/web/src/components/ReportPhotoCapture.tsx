...
import { Photo as SharedPhoto } from "@lynx/types";
...
// Photo is now derived from @lynx/types but with UI-specific additions if needed
export interface Photo extends SharedPhoto {
    uploadedBy?: { firstName: string; lastName: string } | null;
    takenAt: string; // Mapping capturedAt to takenAt or vice versa if needed
}
